              ...
              <div class="row">   
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="0" min="0" max="25" step="5" name="activeBacklog">
                  </div>
                </div>
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="0" min="0" max="20" step="5" name="passiveBacklog">
                  </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
